...
def test_smoke():
    ...
    assert isinstance(model.polarities, np.ndarray) and model.polarities.dtype == np.bool_
    assert isinstance(model.pred, np.ndarray) and model.pred.dtype == np.bool_
